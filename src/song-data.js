export const chapters = [
 ...
 { title:'副歌 · 最瞎卻甜蜜', theme:'rose', action:'dance', lines:['史上最瞎結婚理由','今彩五三九牽紅線牽這麼兇','一個牙妹一個魚妹','號碼一簽兩人都中頭獎圈','你說愛情是運氣還是數學題','笑到流淚也只能說一句','最瞎最瞎卻又有點甜蜜'] },
 { title:'第二幕 · 財神爺點名', theme:'blue', action:'jackpot', lines:['換到小塗這邊','故事居然同一套','今彩五三九播報畫面','他整個人直接跳','魚妹隨手寫的牌','竟然全中好幾排','他說財神爺都點名了','不跟她走進禮堂實在太不應該'] },
 { title:'終幕 · 雙倍幸福', theme:'rose', action:'wedding', lines:['鋒兄牽著牙妹','小塗牽著魚妹','喝喜酒的人一桌一桌','還在笑這兩段緣','最瞎結婚理由','結果都開成頭獎','如果幸福也能這樣瞎忙','那我明天也去買一張'] }
];
